...
enum characters {CLOT, YEETA, BIT, SHMELLY, SALMON, ELSCRIMO, WILL, BARREL, POKO, JOKER, BALD, MAGPIE, FRONK}
...
var characterInfo = {
	characters.BIT:{"poolSize":30, "bulletPath":"Scenes/Bullets/BitBullet.tscn", "playerPath":"res://Scenes/Characters/Bit.tscn"},
